...
%global pkg_name mrpt_pointcloud_pipeline
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-mrpt-pointcloud-pipeline
Version:        2.5.0
Release:        1%{?dist}
...
* Wed Apr 29 2026 Jose-Luis Blanco-Claraco <jlblanco@ual.es> - 2.4.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Jose-Luis Blanco-Claraco <jlblanco@ual.es> - 2.4.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Jose-Luis Blanco-Claraco <jlblanco@ual.es> - 2.4.0-1
- Autogenerated by Bloom
